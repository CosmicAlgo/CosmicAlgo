...
```
Parallel & HPC     MPI  OpenMP  CUDA  ARCHER2  Slurm
ML Infrastructure  PyTorch  TensorFlow  Hugging Face  Scikit-learn
Cloud & DevOps     Azure  Docker  Kubernetes  CI/CD
Data Systems       Spark  PostgreSQL  MongoDB  Redis  Kafka
